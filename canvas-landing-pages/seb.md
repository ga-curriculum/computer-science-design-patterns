# ![Computer Science - Design Patterns](../assets/hero.png)
...
1. Lesson: [Design Patterns](../lesson/README.md)
2. Partner Exercise: [Discussing Design Patterns](../exercise/README.md)

### Time to Complete

40 min total:

- 20 min - Design Patterns Lesson
- 20 min - Discussing Design Patterns Exercise
